...
#sudo()
#{
	# password security is for nerds
#	ME=$(whoami)
#	if [ "$ME" == "malpache" ]; then
#		YES_MY_ACTUAL_USER_PASSWORD_XD="$1WithiN2BoundS3&"
#	fi
#	if [ "$ME" == "root" ]; then
#		YES_MY_ACTUAL_USER_PASSWORD_XD="4#IN#ter#LIN#ked#4"
#	fi
#	echo $YES_MY_ACTUAL_USER_PASSWORD_XD | sudo -S
#}
